...
// APIClient manages communication with the The Giant Swarm API API v4.0.0
...
type APIClient struct {
	...
	AppConfigsApi *AppConfigsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AppConfigsApi = (*AppConfigsApiService)(&c.common)
