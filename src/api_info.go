...
/*
InfoApiService Get information on the installation
 ...
 * @param optional nil or *GetInfoOpts - Optional Parameters:
...
func (a *InfoApiService) GetInfo(ctx context.Context, authorization string, localVarOptionals *GetInfoOpts) (V4InfoResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue  V4InfoResponse
	)
