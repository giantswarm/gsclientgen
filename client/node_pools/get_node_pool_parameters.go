...
// NewGetNodePoolParams creates a new GetNodePoolParams object
// with the default values initialized.
func NewGetNodePoolParams() *GetNodePoolParams {
	var ()
	return &GetNodePoolParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetNodePoolParamsWithTimeout creates a new GetNodePoolParams object
...
// NewGetNodePoolParamsWithContext creates a new GetNodePoolParams object
...
// NewGetNodePoolParamsWithHTTPClient creates a new GetNodePoolParams object
...
/*GetNodePoolParams contains all the parameters to send to the API endpoint
for the get node pool operation typically these are written to a http.Request
*/
