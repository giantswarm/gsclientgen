...
// NewModifyClusterAppV5Params creates a new ModifyClusterAppV5Params object
// with the default values initialized.
func NewModifyClusterAppV5Params() *ModifyClusterAppV5Params {
	var ()
	return &ModifyClusterAppV5Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewModifyClusterAppV5ParamsWithTimeout creates a new ModifyClusterAppV5Params object
...
// NewModifyClusterAppV5ParamsWithContext creates a new ModifyClusterAppV5Params object
...
// NewModifyClusterAppV5ParamsWithHTTPClient creates a new ModifyClusterAppV5Params object
...
/*ModifyClusterAppV5Params contains all the parameters to send to the API endpoint
for the modify cluster app v5 operation typically these are written to a http.Request
*/
...
func (o *ModifyClusterAppV5Params) WithTimeout(timeout time.Duration) *ModifyClusterAppV5Params {
...
func (o *ModifyClusterAppV5Params) WithContext(ctx context.Context) *ModifyClusterAppV5Params {
	o.SetContext(ctx)
	return o
}
...
func (o *ModifyClusterAppV5Params) WithBody(body *models.V4ModifyAppRequest) *ModifyClusterAppV5Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the modify cluster app v5 params
func (o *ModifyClusterAppV5Params) SetBody(body *models.V4ModifyAppRequest) {
	o.Body = body
}
...
func (o *ModifyClusterAppV5Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
